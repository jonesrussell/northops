...
task('deploy:install_services', function (): void {
    ...
    run('systemctl --user enable northops-horizon.service northops-inertia-ssr.service northops-schedule-work.service');
});
...
task('deploy:restart_services', function (): void {
    ...
    run('systemctl --user restart northops-horizon.service northops-inertia-ssr.service northops-schedule-work.service || true');
});
